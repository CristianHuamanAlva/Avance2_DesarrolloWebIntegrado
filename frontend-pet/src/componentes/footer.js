                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-white mb-2" th:href="@{/}"><i class="fa fa-angle-right mr-2"></i>Inicio</a>
                            <a class="text-white mb-2" th:href="@{/about}"><i class="fa fa-angle-right mr-2"></i>Sobre Nosotros</a>
                            <a class="text-white mb-2" th:href="@{/service}"><i class="fa fa-angle-right mr-2"></i>Nuestros Servicios</a>
                            <a class="text-white mb-2" th:href="@{/price}"><i class="fa fa-angle-right mr-2"></i>Precios</a>
                            <a class="text-white" th:href="@{/contact}"><i class="fa fa-angle-right mr-2"></i>Contáctanos</a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-md-right">
                <ul class="nav d-inline-flex">
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" th:href="@{/privacy}">Privacidad</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" th:href="@{/terms}">Términos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" th:href="@{/faq}">Preguntas Frecuentes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white py-0" th:href="@{/help}">Ayuda</a>
                    </li>
                </ul>
            </div>
        </div>
